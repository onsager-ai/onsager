-- Seed: 10 threat categories from governance threat taxonomy

INSERT OR IGNORE INTO threat_categories (id, name, description, severity, severity_weight, examples) VALUES
...
INSERT OR IGNORE INTO rules (id, description, category_id, tools, condition_type, condition_value, lifecycle, alpha, beta, prior_alpha, prior_beta, enabled) VALUES
