...
use crate::nodes::context::{ExecutorContext, ExecutorOutputs};
use crate::nodes::error::ExecutorError;
use crate::nodes::executor::Executor;
use crate::nodes::spine::{EmittedArtifact, SessionManifest};
...
mod tests {
    ...
    fn ctx_with_manifest(
        ...
        let ctx = ExecutorContext {
            plan_id: crate::nodes::scheduler::PlanId::generate(),
            node_id,
            inputs: Vec::new(),
            spine: Arc::clone(&mock) as Arc<dyn crate::nodes::SpineClient>,
    ...
    async fn execute_renders_inputs_into_user_prompt() {
        ...
        let ctx = ExecutorContext {
            ...
            spine: mock as Arc<dyn crate::nodes::SpineClient>,
            subworkflow_ref: None,
            agent_config: None,
            session_token: None,
            repos_env: None,
