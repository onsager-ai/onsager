...
use crate::scheduler::plan_registry::derive_plan_id;
use crate::scheduler::plan_runner::{PlanRunError, PlanRunner};
...
mod tests {
    ...
    fn build_bridge() -> (TriggerBridge, Arc<CapturingSpine>) {
        let mut registry = crate::nodes::ExecutorRegistry::new();
