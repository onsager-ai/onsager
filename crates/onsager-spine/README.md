...
- **`events_ext`** — wide JSON extension table namespaced by component. Each component owns a `namespace` (e.g. `"session"`) and can publish arbitrary extension events without changing the core schema.
