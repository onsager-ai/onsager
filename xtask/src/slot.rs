...
/// developers who never create a worktree. The legacy ports (3000 /
/// 3001) are owned by `just dev` directly, not by the slot
...
/// network. The dashboard reaches the backend via Caddy's
