...
| [0030](0030-scaling-sessions-across-machines.md) | Scaling agent sessions across machines | Accepted (2026-06-15, building — owner override of the defer; M1–M2 landed) — `Identity impact: yes` — amends ADR 0029's one-process commitment |
