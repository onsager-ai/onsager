...
| [0006](0006-edge-dispatcher-as-the-public-boundary.md) | Edge dispatcher as the public boundary | Proposed (2026-05-09, amended 2026-05-09 by ADR 0008) — `Identity impact: no` |
...
| [0008](0008-portal-owns-the-agent-control-plane.md) | Portal owns the agent control plane | Proposed (2026-05-09) — `Identity impact: no` |
