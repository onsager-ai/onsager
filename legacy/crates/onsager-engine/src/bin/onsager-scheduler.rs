...
//! [`onsager_engine::nodes::Scheduler`].
//!
...
use onsager_engine::scheduler::{SchedulerService, ServiceConfig};
    ...
    tracing_subscriber::fmt()
        .with_env_filter(
            tracing_subscriber::EnvFilter::try_from_default_env().unwrap_or_else(|_| {
                tracing_subscriber::EnvFilter::new("onsager_engine::scheduler=info")
            }),
        )
        .compact()
        .init();
