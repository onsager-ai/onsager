...
use crate::nodes::SpineClient;
use crate::nodes::scheduler::PlanId;
...
pub struct ExecutorContext {
    ...
    /// `AgentExecutor` copies it onto its [`crate::nodes::AgentRequest`] so the
    ...
    /// [`crate::nodes::AgentRequest`] so the runner injects it as `ONSAGER_REPOS`
...
impl ExecutorOutputs {
    ...
    /// (including [`crate::nodes::NoOpExecutor`]).
    pub fn empty() -> Self {
        Self::default()
    }
...
mod tests {
    use super::*;
    use crate::nodes::spine::test_support::{MockSpine, dummy_artifact};
